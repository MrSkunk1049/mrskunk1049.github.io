...
function startGame(){
    ...
    */
    ...
    //Start the movement
    speed = document.getElementById("speedhackoutput").value;
    delayIncrement = 300 / speed;
    window.setTimeout(function(){
    ...
    const endscreenStartTime = 1700 + delayIncrement * 26 + 300; // 9800ms default
    window.setTimeout(function(){
    ...
    7    4
     6  5
    */
   const rotationStartTime = endscreenStartTime + 800; // 10600ms default
    window.setTimeout(function(){
        guessingTime = true;
...
function diagSwitch(curPos) {
    ...
    let interval = setInterval(() => {
        ...
        i++;
    }, 5 / speed); //Runs every 5ms, so full movement takes ~250ms
